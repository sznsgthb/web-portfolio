...
function About() {
    ...
    const isSmall = width <= 1025; // breakpoint for "small" layout
            ...
            <div className="container-small">
                ...
                <div className='header-small'>
                    <ScrollAnimation animation="fadeInUp" delay={500}>                   
                            <h1 className="h1-about-small">A bit about me</h1>
                    </ScrollAnimation>
                    <ScrollAnimation animation="fadeIn" delay={1250}>
                        <div className='picture-small'>
                            <img src={profilepicture} alt='Suzanne' />
                        </div>
                    </ScrollAnimation>
                </div>
    ...
    return (
        <div>
                <ScrollAnimation animation="fadeInUp" delay={500}>                   
                        <h1 className="h1-about-large">A bit about me</h1>
                </ScrollAnimation>
